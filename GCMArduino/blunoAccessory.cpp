...
//////////////////////////////////////////////////
//uint16_t noteLength = 500;
//uint16_t restLength = 150;
//float tempoScale = 1.0f;
//
//void blunoAccessory::play(uint8_t note)
//{
//  tone(buzzerPin, notes[note], noteLength * tempoScale);
//}
//
//double playNote(EMusicalNotes note)
//{
//  static const double powerA = 1.059463094359;
//  return 27.5 * pow(powerA, ((uint16_t)note));
//}
//
//void blunoAccessory::play(EMusicalNotes note)
//{
//  tone(buzzerPin, playNote(note), noteLength * tempoScale);
//}
//
//void blunoAccessory::playTone()
//{
//  //for (uint8_t i = 0; i < /*sizeof(notes) / sizeof(notes[0])*/5; i++)
//  //{
//  //  play(i);
//  //  delay((noteLength + restLength) * tempoScale);
//  //}
//
//  play(noteG3);
//  delay((noteLength + restLength) * tempoScale);
